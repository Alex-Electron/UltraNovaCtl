...
**Нумерация кнопок и ламп совпадает только до 34.** Дальше лампы уходят в индикаторы, за
которыми нет кнопок. Код 35 — это `VALUE +`, если его нажать, и второй индикатор вокодера,
если его зажечь.
