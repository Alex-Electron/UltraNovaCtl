...
| Index | Control |
|---:|---|
| 0–7 | the eight encoders under the display. On the panel they sit between the patch dial on their left and the filter knob on their right, so the numbering is not the physical order |
| 8 | filter knob |
